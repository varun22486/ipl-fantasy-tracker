          ...
          <div style={sectionStyle}>
            ...
            <ResponsiveContainer width="100%" height={270}>
              <AreaChart data={cumulData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                ...
                <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 3, "url(#gradYou)")} />
                <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 3, "url(#gradOpp)")} />
              </AreaChart>
            </ResponsiveContainer>
                ...
                <div>
                  ...
                  <ResponsiveContainer width="100%" height={220}>
                    <AreaChart data={runsRunningData} margin={{ top: 5, right: 16, left: 0, bottom: 0 }}>
                      ...
                      <Tooltip content={<ChartTooltip formatter={(v: number) => `${v} runs`} />} />
                      <Legend wrapperStyle={{ fontSize: 12 }} />
                      <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 2.5, "url(#runsGradYou)")} />
                      <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 2.5, "url(#runsGradOpp)")} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <ResponsiveContainer width="100%" height={220}>
                      <AreaChart data={wicketsRunningData} margin={{ top: 5, right: 16, left: 0, bottom: 0 }}>
                        ...
                        <Tooltip content={<ChartTooltip formatter={(v: number) => `${v} wkt${v !== 1 ? "s" : ""}`} />} />
                        <Legend wrapperStyle={{ fontSize: 12 }} />
                        <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 2.5, "url(#wktsGradYou)")} />
                        <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 2.5, "url(#wktsGradOpp)")} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <ResponsiveContainer width="100%" height={220}>
                    <AreaChart data={catchesRunningData} margin={{ top: 5, right: 16, left: 0, bottom: 0 }}>
                      ...
                      <Tooltip content={<ChartTooltip formatter={(v: number) => `${v} catch${v !== 1 ? "es" : ""}`} />} />
                      <Legend wrapperStyle={{ fontSize: 12 }} />
                      <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 2.5, "url(#ctGradYou)")} />
                      <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 2.5, "url(#ctGradOpp)")} />
                    </AreaChart>
                  </ResponsiveContainer>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <ResponsiveContainer width="100%" height={220}>
                      <AreaChart data={runoutsRunningData} margin={{ top: 5, right: 16, left: 0, bottom: 0 }}>
                        ...
                        <Tooltip content={<ChartTooltip formatter={(v: number) => `${v} credit${v !== 1 ? "s" : ""}`} />} />
                        <Legend wrapperStyle={{ fontSize: 12 }} />
                        <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 2.5, "url(#roGradYou)")} />
                        <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 2.5, "url(#roGradOpp)")} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <ResponsiveContainer width="100%" height={220}>
                      <AreaChart data={stumpingsRunningData} margin={{ top: 5, right: 16, left: 0, bottom: 0 }}>
                        ...
                        <Tooltip content={<ChartTooltip formatter={(v: number) => `${v} stump${v !== 1 ? "s" : ""}`} />} />
                        <Legend wrapperStyle={{ fontSize: 12 }} />
                        <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 2.5, "url(#stGradYou)")} />
                        <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 2.5, "url(#stGradOpp)")} />
                      </AreaChart>
                    </ResponsiveContainer>
                  </div>
                </div>
              ...
              <div>
                ...
                <ResponsiveContainer width="100%" height={220}>
                  <AreaChart data={captainPtsRunningData} margin={{ top: 5, right: 16, left: 0, bottom: 0 }}>
                    ...
                    <Tooltip content={<ChartTooltip formatter={(v: number) => `${v} pts`} />} />
                    <Legend wrapperStyle={{ fontSize: 12 }} />
                    <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 2.5, "url(#capGradYou)")} />
                    <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 2.5, "url(#capGradOpp)")} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
              </div>
              ...
              <div style={sectionStyle}>
                ...
                <ResponsiveContainer width="100%" height={240}>
                  <ComposedChart data={winRateData} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
                    ...
                    <Legend wrapperStyle={{ fontSize: 13 }} />
                    <Area type="monotone" dataKey={yourName} {...areaSeriesProps(YOU_COLOR, 2.5, "url(#winGradYou)")} />
                    <Area type="monotone" dataKey={opponentName} {...areaSeriesProps(OPP_COLOR, 2.5, "url(#winGradOpp)")} />
                  </ComposedChart>
                </ResponsiveContainer>
              </div>
            )}
